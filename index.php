...
<head>
    ...
    <title>Simple Video upload with php</title>
    ...
    <div class="col-md-6 well">
        ...
        <div class="col-md-12">
            <div class="col-md-4" style="word-wrap:break-word;">
                <br />
                <h4>Video Name</h4>
                <h5 class="text-primary"><?php echo htmlspecialchars($fetch['video_name']); ?></h5>
            </div>
            <div class="col-md-8">
                <video width="100%" height="240" controls>
                    <source src="<?php echo htmlspecialchars($fetch['location']); ?>">
                </video>
            </div>
            <br style="clear:both;"/>
        ...
        <?php
            ...
            echo '<div class="alert alert-info">No videos uploaded yet.</div>';
        }
        ?>
    </div>
